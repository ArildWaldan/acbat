...
export const DECORS: { [key: string]: Decor } = {
  "authenticChene": {
      ...
      variants: {
          standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '2s', sizes: [{ width: 730, price: 136.64, code: 'MC' }, { width: 830, price: 144.27, code: 'MC' }] },
          climat: { name: "Vantail Battant Climat 3", height: 2040, delai: '8s', mandatoryKit: 'kitClimat', cadreType: 'climat', info: 'Plinthe escamotable 32 dB', sizes: [{ width: 730, price: 379.08, code: 'MC' }, { width: 830, price: 379.08, code: 'MC' }] },
          coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '2s', sizes: [{ width: 730, price: 165.72, code: 'MC' }, { width: 830, price: 165.72, code: 'MC' }, { width: 930, price: 165.72, code: 'MC' }] }
      }
  },
  "authenticBlanc": {
  ...
  "cheneOntario": {
      ...
      variants: {
          standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '2s', sizes: [{ width: 730, price: 149.17, codes: { G: '101275210', D: '101275211' } }, { width: 830, price: 149.17, codes: { G: '101275212', D: '101275213' } }, { width: 930, price: 150.38, code: 'MC' }] },
          climat: { name: "Vantail Battant Climat 3", info: 'Plinthe escamotable 32 dB', height: 2040, delai: '8s', cadreType: 'climat', sizes: [{ width: 730, price: 612.89, code: 'MC' }, { width: 830, price: 612.89, code: 'MC' }, { width: 930, price: 612.89, code: 'MC' }] },
          coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 217.43, code: '101275214' }, { width: 830, price: 217.43, code: '101275215' }, { width: 930, price: 217.43, code: 'MC' }] }
      }
  },
  "cheneOntarioTabac": { name: "Chêne Ontario Tabac", gamme: 'cpl', cadreId: 'cpl_ontario_60', plusValues: ['surMesure_55', 'chantCeruse', 'oculus_ontario', 'cadreNoirMat'], variants: { standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 149.17, code: 'MC' }, { width: 830, price: 149.17, code: 'MC' }, { width: 930, price: 150.38, code: 'MC' }] }, climat: { name: "Vantail Battant Climat 3", info: 'Plinthe escamotable 32 dB', height: 2040, delai: '8s', cadreType: 'climat', sizes: [{ width: 730, price: 646.37, code: 'MC' }, { width: 830, price: 646.37, code: 'MC' }, { width: 930, price: 646.37, code: 'MC' }] }, coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 217.30, code: 'MC' }, { width: 830, price: 217.30, code: 'MC' }, { width: 930, price: 217.30, code: 'MC' }] } } },
  "cheneOntarioBlanc": { name: "Chêne Ontario Blanc", gamme: 'cpl', cadreId: 'cpl_ontario_60', plusValues: ['surMesure_55', 'chantCeruse', 'oculus_ontario', 'cadreNoirMat'], variants: { standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 149.17, code: 'MC' }, { width: 830, price: 149.17, code: 'MC' }, { width: 930, price: 150.38, code: 'MC' }] }, climat: { name: "Vantail Battant Climat 3", info: 'Plinthe escamotable 32 dB', height: 2040, delai: '8s', cadreType: 'climat', sizes: [{ width: 730, price: 646.37, code: 'MC' }, { width: 830, price: 646.37, code: 'MC' }, { width: 930, price: 646.37, code: 'MC' }] }, coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 217.30, code: 'MC' }, { width: 830, price: 217.30, code: 'MC' }, { width: 930, price: 217.30, code: 'MC' }] } } },
  "top400": { name: "Top 400", gamme: 'cpl', cadreId: 'cpl_ontario_60', plusValues: ['surMesure_55', 'chantCeruse', 'oculus_ontario', 'cadreNoirMat'], variants: { standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 215.81, code: 'MC' }, { width: 830, price: 215.81, code: 'MC' }, { width: 930, price: 215.81, code: 'MC' }] }, climat: { name: "Vantail Battant Climat 3", info: 'Plinthe escamotable 32 dB', height: 2040, delai: '8s', cadreType: 'climat', sizes: [{ width: 730, price: 1123.24, code: 'MC' }, { width: 830, price: 1123.24, code: 'MC' }, { width: 930, price: 1123.24, code: 'MC' }] }, coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 403.02, code: 'MC' }, { width: 830, price: 403.02, code: 'MC' }, { width: 930, price: 403.02, code: 'MC' }] } } },
  "unicolorNoir": { name: "Aspect Bois / CPL Noir anti-trace", gamme: 'cpl_plus', cadreId: 'cpl_plus_prestige_65', plusValues: ['surMesure_30', 'serrure3points', 'porteAffleurante', 'oculus_noir', 'cadreNoirMat'], variants: { standard: { name: "Vantail Battant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 263.63, code: 'MC' }, { width: 830, price: 263.63, code: 'MC' }, { width: 930, price: 263.63, code: 'MC' }] }, climat: { name: "Vantail Battant Climat 3", info: 'Plinthe escamotable 32 dB', height: 2040, delai: '8s', cadreType: 'climat_prestige', sizes: [{ width: 730, price: 839.71, code: 'MC' }, { width: 830, price: 839.71, code: 'MC' }, { width: 930, price: 839.71, code: 'MC' }] }, coulissant: { name: "Vantail Coulissant Tubulaire", height: 2040, delai: '8s', sizes: [{ width: 730, price: 418.02, code: 'MC' }, { width: 830, price: 418.02, code: 'MC' }, { width: 930, price: 418.02, code: 'MC' }] } } },
};
